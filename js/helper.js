...
var HTMLskillsStart = '<br><br><br><h3 id="skillsH3">Skills at a Glance:</h3><ul id="skills" class="flex-box"></ul>';
...
$(document).ready(function() {
  $('button').click(function() {
    var iName = inName(document.getElementById("name").innerHTML) || function(){};
    $('#name').html(iName);  
  });
});
